                        ...
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                ...
                                <div class="col-xs-12">
                                    <div class="col-md-12">
                                        <br>
                                        <form action="{{route('store.holy')}}" method="post" autocomplete="off" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="form-row">
                                            <div class="col">
                                                <label for="title">عدد ايام الاجازة</label>
                                                <input type="number" name="numofday" class="form-control" style="width: 150px">
                                                {{-- @error('email')

    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">Delete_attachment</h5>
            ...
            <div class="modal-body">
                <form action="{{route('Delete_attachment')}}" method="post">
                    ...
                    <input type="hidden" name="name" value="{{$attachment->imageable->name}}">
                    <input type="hidden" name="student_id" value="{{$attachment->imageable->id}}">

                    <h5 style="font-family: 'Cairo', sans-serif;">Delete This Image</h5>

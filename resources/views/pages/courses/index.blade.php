                                ...
                                {{-- <a href="{{route('Dr.create')}}" class="btn btn-success btn-sm" role="button"
                                    ...
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        @foreach($courses as $course)
                                            ...
                                            <td><img style="width: 60px;height: 60px;" src="{{ asset('Courses/' . $course->image) }}"></td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                @method('patch')
                    ...
                    <div class="row">
                        <div class="col">
                            <label for="name" class="mr-sm-2">اسم الكورس
                                :</label>
                    ...
                    <div class="row">
                        <div class="col">
                            <label for="name" class="mr-sm-2">تعريف الكورس
                                :</label>
                    ...
                    <div class="row">
                        <div class="col">
                            <label for="name" class="mr-sm-2">Name
                                ...
                                <input type="file" name="image" class="file-upload-default" value="{{ asset('Courses/' . $course->image) }}>
                        </div>
                            ...
                            class="btn btn-success">تأكيد</button>
                                            ...
                                            <div class="modal fade" id="delete_course{{$course->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">حذف</h5>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                            </button>
                                                        </div>

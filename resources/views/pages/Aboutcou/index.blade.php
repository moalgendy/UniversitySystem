                                ...
                                {{-- <a href="{{route('Dr.create')}}" class="btn btn-success btn-sm" role="button"
                                    ...
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        @foreach($courses as $course)
                                            ...
                                            <td><img style="width: 120px;height: 60px;" src="{{ asset('Aboutcou/' . $course->image) }}"></td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- add_form -->
                <form action="{{ route('aboutcou.update',$course->id) }}" method="post" enctype="multipart/form-data">
                @method('patch')
                    @csrf
                    <div class="row">
                        <div class="col">
                    ...
                    <div class="row">
                        <div class="col">
                            <label for="name" class="mr-sm-2">الصورة
                                ...
                                <input type="file" name="image" class="file-upload-default" value="{{ asset('aboutcou/' . $course->image) }}">
                        </div>

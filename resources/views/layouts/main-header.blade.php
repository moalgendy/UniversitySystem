            ...
            <ul class="nav navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown mr-30">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a style="padding-right: 20px" class="dropdown-item" href="{{ url('profile') }}">{{ __('university.profile') }}</a>
                        @else
                        ...
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" style="padding-right: 40px" href="#"> --}}
                            {{-- <i class="text-info ti-settings"></i> --}}
                            {{-- Settings</a> --}}
                        {{-- < class="dropdown-item" href="#"><i class="text-danger ti-unlock"></i> --}}
                        <a style="padding-right: 20px" class="dropdown-item preview-item" href="{{ route('logout') }}" onclick="event.preventDefault();
                            document.getElementById('logout-form').submit();">{{ __('university.logout') }}</a>

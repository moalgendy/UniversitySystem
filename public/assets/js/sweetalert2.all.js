...
(function(global, factory) {
        ...
        classList.forEach(function(name) {
            if (target.forEach) {
                target.forEach(function(elem) {
                    add ? elem.classList.add(name) : elem.classList.remove(name);
                });
            } else {
                add ? target.classList.add(name) : target.classList.remove(name);
            }
        });
    };
    ...
    var getChildByClass = function getChildByClass(elem, name) {
